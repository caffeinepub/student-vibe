...
import type { ExternalBlob as _ExternalBlob, Note as _Note, NoteMetadata as _NoteMetadata, Quiz as _Quiz, StripeSessionStatus as _StripeSessionStatus, StudyGroup as _StudyGroup, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createStudyGroup(arg0: string, arg1: string, arg2: string): Promise<StudyGroup> {
        if (this.processError) {
            try {
                const result = await this.actor.createStudyGroup(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateQuizFromAI(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateQuizFromAI(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateSummaryFromAI(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateSummaryFromAI(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateVivaFromAI(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateVivaFromAI(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAdminUserProfile(): Promise<UserProfile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getAdminUserProfile();
    ...
    async getNote(arg0: string): Promise<Note | null> {
        if (this.processError) {
            try {
    ...
    async getStudyGroup(arg0: string): Promise<StudyGroup | null> {
        if (this.processError) {
            try {
    ...
    async getVivaQuestions(arg0: string): Promise<Array<VivaQuestion>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVivaQuestions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async joinStudyGroup(arg0: string): Promise<StudyGroup> {
        if (this.processError) {
            try {
    ...
    async saveQuiz(arg0: string, arg1: Array<QuizQuestion>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async saveVivaQuestions(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveVivaQuestions(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchUsersByEmail(arg0: string): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
    ...
    async setUserAdminStatus(arg0: Principal, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setUserAdminStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setUserPremiumStatus(arg0: Principal, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setUserPremiumStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadNote(arg0: string, arg1: NoteMetadata, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadNote(arg0, arg1, await to_candid_ExternalBlob_n29(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Note_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Note): Promise<Note> {
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Note]): Promise<Note | null> {
    return value.length === 0 ? null : await from_candid_Note_n18(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Quiz]): Quiz | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StudyGroup]): StudyGroup | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        department: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.department)),
        yearOfStudy: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.yearOfStudy)),
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Note>): Promise<Array<Note>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Note_n18(_uploadFile, _downloadFile, x)));
}
...
function to_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        yearOfStudy: value.yearOfStudy ? candid_some(value.yearOfStudy) : candid_none(),
        college: value.college
    };
}
